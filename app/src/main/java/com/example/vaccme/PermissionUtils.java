//this is all google sample boilerplate code;
    ...
    public static class PermissionDeniedDialog extends DialogFragment {
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            if (finishActivity) {
                ...
                //Maor - changed this to go back to the dashboard
                getActivity().startActivity(new Intent(getActivity(),MainScreenActivity.class));
                getActivity().finish();
